...
public class RellenadorTbl {
    
    CtrlArticulos ca = new CtrlArticulos();
    CtrlClientes cc = new CtrlClientes();
    CtrlFacturas cf = new CtrlFacturas();
    
    public RellenadorTbl() {}
    
    public void rellenarTbl(DefaultTableModel model, String tabla) {
        ...
        if ("Clientes".equals(tabla)) {
            ...
            ArrayList<Clientes> listaClientes = cc.getListaClientes();
            ...
            ArrayList<Articulos> listaArticulos = ca.getListaArticulos();
            Set<Articulos> set = new LinkedHashSet<>(listaArticulos);
            listaArticulos.clear();
            listaArticulos.addAll(set);
            ...
            ArrayList<FacturasCab> listaFacturasCab = cf.getListaFacturasCab();
            ...
            ArrayList<FacturasLin> listaFacturasLin = cf.getListaFacturasLin();
            ...
            ArrayList<FacturasTot> listaFacturasTot = cf.getListaFacturasTot();
            ...
            ArrayList<EstadisticasClientes> listaEstadisticas = cc.getListaEstadisticasClientes();
            ...
            for (int i = 0; i < listaEstadisticas.size(); i++){
                ...
                Object[] data = {anio, mesNum, mesNom, dni, sumaBase, sumaDtos, sumaIva, sumaTotales};
